  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 text-center">
        ...
        <p className="text-sm text-slate-500 mt-4">Sem cartão de crédito • Plano grátis para sempre</p>
      </section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-slate-200 shadow-sm">
              <CardHeader>
                ...
                <CardTitle className="text-lg">Pipeline Kanban</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            ...
            <Card className="border-slate-200 shadow-sm">
              <CardHeader>
                <Badge className="w-fit bg-slate-100 text-slate-700 hover:bg-slate-100 border-slate-200">Grátis</Badge>
                <CardTitle className="text-2xl mt-3">R$ 0</CardTitle>
            ...
            <Card className="border-blue-600 shadow-lg ring-2 ring-blue-600">
              <CardHeader>
                ...
                <CardTitle className="text-2xl mt-3">R$ 49<span className="text-base font-normal text-slate-500">/mês</span></CardTitle>
                <p className="text-slate-500 text-sm">Por workspace</p>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  {[
      ...
      <footer className="border-t border-slate-100 py-8">
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between text-sm text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-slate-700">PipeFlow</span>
          </div>
